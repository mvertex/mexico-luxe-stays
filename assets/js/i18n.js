...
const MLS_I18N = {
  en: {
    ...
    "services.cta.eyebrow": "And whatever we didn't list",
    ...
    "about.story.body": "Two decades later, we manage a handpicked collection across two of Mexico's most breathtaking destinations — the Riviera Maya and Valle de Guadalupe. We stayed deliberately small. The same people who answer your first message will greet you at the door, adjust the jacuzzi at midnight, and wave you off at departure. That is the whole business model, and we've never needed another one.",
  ...
  es: {
    ...
    "services.cta.eyebrow": "Y lo que no está en la lista",
    ...
    "about.story.body": "Dos décadas después, administramos una colección seleccionada a mano en dos de los destinos más impresionantes de México — la Riviera Maya y el Valle de Guadalupe. Decidimos mantenernos deliberadamente pequeños. Las mismas personas que responden tu primer mensaje te reciben en la puerta, ajustan el jacuzzi a medianoche y te despiden a la salida. Ese es todo el modelo de negocio, y nunca hemos necesitado otro.",
    "about.stats.1.num": "20+",
